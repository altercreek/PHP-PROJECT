...
$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'jhsqwqwgduwgs 5555');
...
foreach($obj->View_std_prof("pf_std._id='1'")AS $value){
/* $i=0; */
extract($value); 
	...
	$html .="<tr>";  
        ...
        $i = 0;  
            ...
            $html .= "<th>". 'jahid'.$value['_sh_name'] . "</th>";
              $html .= "<th>". 'jahid'.$value['_sh_name'] . "</th>";
 $html .= "<th>". 'jahid'.$value['_sh_name'] . "</th>";	
$html .= "<th>". 'jahid'.$value['_sh_name'] . "</th>";	 
...
$html .="<tr>";  
    ...
    $pdf->Output('somefile.pdf'); // the second option D forces the browser to download the PDF. Passing I will tell the browser to show it inline.
...
<table cellspacing="0" cellpadding="1" border="1">
    <tr>
															...
															<td class=""><b>Mobile No:</b></td>
															<td class=""><b>Occupation:</b></td>
														...
														<tr>       
															...
															<td class=""><b>Home Phone:</b></td>
															<td class=""><b>Nationality:</b></td>
															<td class=""><b>National ID:</b></td>

															
														</tr>
														<tr>
															<td class=""><b>Office Address:</b></td>
															<td class=""><b>Yearly Income:</b></td>
															<td class=""><b>Office Phone:</b></td>
															<td class=""><b></b></td>
